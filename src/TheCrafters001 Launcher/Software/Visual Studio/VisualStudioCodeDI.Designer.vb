...
Partial Class VisualStudioCodeDI
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(VisualStudioCodeDI))
        ...
        Me.Label1.Text = "Visual Studio Code Download/Install"
        '
        'VisualStudioCodeDI
        '
